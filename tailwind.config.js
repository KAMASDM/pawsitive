...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "neu-flat":
          "3px 3px 6px 0 rgba(0, 0, 0, 0.05), -3px -3px 6px 0 rgba(255, 255, 255, 0.8)",
        "neu-pressed":
          "inset 2px 2px 5px 0 rgba(0, 0, 0, 0.05), inset -3px -3px 7px 0 rgba(255, 255, 255, 0.8)",
        "neu-convex":
          "3px 3px 6px 0 rgba(0, 0, 0, 0.1), -3px -3px 6px 0 rgba(255, 255, 255, 0.8), inset 1px 1px 1px 0 rgba(255, 255, 255, 0.2)",
        "neu-concave":
          "inset 1px 1px 1px 0 rgba(0, 0, 0, 0.05), inset -1px -1px 1px 0 rgba(255, 255, 255, 0.8), 2px 2px 4px 0 rgba(255, 255, 255, 0.5), -2px -2px 4px 0 rgba(0, 0, 0, 0.05)",
      ...
      backgroundImage: {
        "neu-gradient-1":
          "linear-gradient(145deg, rgba(255,255,255,0.6) 0%, rgba(240,240,240,0.1) 100%)",
        "neu-gradient-2":
          "linear-gradient(to bottom right, rgba(255,255,255,0.8), rgba(240,240,240,0.2))",
        "neu-gradient-3":
          "linear-gradient(to bottom right, rgba(255,255,255,0.2), rgba(240,240,240,0.8))",
    ...
    function ({ addComponents, theme }) {
      const neumorphicComponents = {
        ".btn-neu": {
          ...
          "&:hover": {
            boxShadow:
              "2px 2px 4px 0 rgba(0, 0, 0, 0.1), -2px -2px 4px 0 rgba(255, 255, 255, 0.9)",
        ...
        ".card-neu": {
          ...
          "&:hover": {
            boxShadow:
              "4px 4px 8px 0 rgba(0, 0, 0, 0.1), -4px -4px 8px 0 rgba(255, 255, 255, 0.9)",
        ...
        ".input-neu": {
          ...
          backgroundColor: "#f0f0f0",
          boxShadow:
            "inset 2px 2px 5px 0 rgba(0, 0, 0, 0.05), inset -3px -3px 7px 0 rgba(255, 255, 255, 0.6)",
          border: "none",
          padding: "0.75rem 1rem",
          transition: "all 0.2s ease",
          "&:focus": {
            boxShadow:
              "inset 3px 3px 6px 0 rgba(0, 0, 0, 0.1), inset -3px -3px 6px 0 rgba(255, 255, 255, 0.7)",
            outline: "none",
          },
        },
        ".switch-neu": {
