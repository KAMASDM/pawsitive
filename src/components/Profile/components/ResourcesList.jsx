...
const ResourcesList = ({ resources = [] }) => {
  ...
  const categories = [
    ...
    ...new Set(
      resources.map(
        (resource) => resource.category?.toLowerCase() || "uncategorized"
      )
    ),
  ];
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="mt-6 p-3 bg-lavender-50 rounded-lg">
                  <p className="text-sm text-lavender-900 flex items-start">
                    ...
                    <span>
                      You can browse more resources in the Resources section to
                      find helpful information for your pets.
                    </span>
                  </p>
                </div>
              </div>
...
const ResourceCard = ({ resource, navigate, formatDate }) => {
  return (
    ...
    >
      ...
      <div className="p-4">
        <h3 className="font-bold text-lavender-900 text-lg mb-2 line-clamp-1">
          {resource.name}
        </h3>
