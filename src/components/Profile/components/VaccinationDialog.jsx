// src/components/Profile/components/VaccinationDialog.jsx
import React, { useState, useEffect } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { FiX, FiCalendar, FiPlus, FiInfo, FiChevronDown, FiSearch, FiCheck } from "react-icons/fi";
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  >
                    <span className={`${selectedVaccine ? 'text-gray-900' : 'text-gray-500'}`}>
                      {selectedVaccine || 'Select vaccination type'}
                    </span>
                    <FiChevronDown className={`text-gray-400 transition-transform ${vaccineDropdownOpen ? 'rotate-180' : ''}`} />
                  </button>
                        ...
                        <div className="max-h-52 overflow-y-auto p-2">
                            ...
                            filteredVaccinations.map((vaccine) => (
                              <button
                                ...
                                className={`w-full text-left px-3 py-2 rounded-md text-sm hover:bg-lavender-50 transition-colors ${
                                  selectedVaccine === vaccine ? 'bg-lavender-100 text-lavender-900 font-medium' : 'text-gray-700'
                                }`}
                              >
                                <div className="flex items-center">
                          ...
                          <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-md text-sm mt-2 border-t border-lavender-100 pt-3 hover:bg-lavender-50 transition-colors ${
                              selectedVaccine === "Other" ? 'bg-lavender-100 text-lavender-900 font-medium' : 'text-gray-700'
                            }`}
                          >
                            <div className="flex items-center">
              ...
              <div className="mb-6 p-3 bg-lavender-50 rounded-lg flex items-start">
                ...
                <div className="text-xs text-lavender-900">
                  <p>Regular vaccinations help protect your pet from serious diseases and are often required by law or for services like boarding and grooming.</p>
                </div>
              </div>
