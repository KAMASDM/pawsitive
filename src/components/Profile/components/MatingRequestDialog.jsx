// src/components/Profile/components/MatingRequestDialog.jsx
...
const MatingRequestDialog = ({
  ...
  const [step, setStep] = useState(1); // 1: Preview, 2: Message, 3: Success
    ...
    if (step === 2) {
      ...
      try {
        await onSend({
          ...
          message: message || `Hello! I'd like to arrange mating between our pets.`,
          createdAt: Date.now(),
          status: 'pending'
        });
  ...
  // Get pet details in a readable format
              ...
              <AnimatePresence mode="wait">
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <p className="text-lavender-100">
                      Let {receiverPet?.name}'s owner know more about your interest
                    </p>
                  </motion.div>
                )}
                  ...
                  >
                    <div className="flex items-center justify-center space-x-12 mb-8">
                      ...
                      <div className="text-center">
                        ...
                        <h3 className="font-medium text-lavender-900">{senderPet?.name}</h3>
                        <p className="text-xs text-gray-500 mt-1">{getPetDetails(senderPet)}</p>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        <h3 className="font-medium text-lavender-900">{receiverPet?.name}</h3>
                        <p className="text-xs text-gray-500 mt-1">{getPetDetails(receiverPet)}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-lavender-50 p-4 rounded-xl mb-6 flex items-start">
                      ...
                      <div className="text-sm text-lavender-900">
                        <p className="mb-1">You're about to send a mating request for your pet {senderPet?.name} with {receiverPet?.name}.</p>
                        <p>The owner will review your request and may contact you to discuss details.</p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="mb-6">
                      ...
                      <textarea
                        ...
                        placeholder={`Hello! I'd like to arrange a mating between my pet ${senderPet?.name} and your pet ${receiverPet?.name}. My pet is a ${senderPet?.breed || ""} ${senderPet?.gender || ""}, ${senderPet?.age || ""}. Please let me know if you're interested.`}
                        rows={6}
                      ></textarea>
                    </div>
                  ...
                  >
                    <div className="my-6">
                      <p className="text-gray-700 mb-6">
                        Your mating request has been sent to {receiverPet?.name}'s owner.
                      ...
                      <div className="flex justify-between bg-lavender-50 p-4 rounded-xl mx-auto max-w-xs">
                        <div className="text-center">
                          ...
                          <p className="text-xs font-medium text-lavender-900">{senderPet?.name}</p>
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs font-medium text-lavender-900">{receiverPet?.name}</p>
                        </div>
                      </div>
                    </div>
