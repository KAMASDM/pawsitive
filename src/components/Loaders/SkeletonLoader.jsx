      ...
      <div className="animate-pulse">
        ...
        <div className="px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              <div className={`h-8 bg-${themeColor}-200 rounded w-1/3 mb-4`} />
          ...
          <div className="flex justify-center gap-4">
            <div className={`h-12 bg-${themeColor}-200 rounded-full w-32`} />
            <div className="h-12 bg-green-200 rounded-full w-32" />
